package mymod.entities;
	...
	import mymod.library.entities.mobs.models.LibModelBase;
	import mymod.library.entities.mobs.models.LibModelCow;
	import mymod.library.entities.mobs.models.LibModelGhast;
	import mymod.library.entities.mobs.models.LibModelLlama;
	import mymod.library.entities.mobs.models.LibModelOcelot;
	import mymod.library.entities.mobs.models.LibModelPig;
	import mymod.library.entities.mobs.models.LibModelPolarBear;
	import mymod.library.entities.mobs.models.LibModelRabbit;
	import mymod.library.entities.mobs.models.LibModelSkeleton;
	import mymod.library.entities.mobs.models.LibModelZombie;
	...
	public class MyModRenderMob extends RenderLiving<EntityLiving> {

	    private ResourceLocation texture;
	    private float scale;

	    public MyModRenderMob(RenderManager manager, Class<? extends EntityLiving> entityClass, ModelBase model) {
	    ...
	    public MyModRenderMob setTexture(ResourceLocation texture) {
	        this.texture = texture;
	        return this;
	    }

	    public MyModRenderMob setScale(float scale) {
	        this.scale = scale;
